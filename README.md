...
大喜利AI検定は、AIが出すお題に挑戦して大喜利の実力をAIが判定するアプリです。Gemini AIがお題を生成し、あなたの回答を採点してヒントもくれます。
...
### ゲームモード
- **検定モード**: Gemini AIが多様なジャンルからお題を自動生成
...
### ランキング・共有
- **TOP100ランキング**: 高得点の回答をお題・ニックネーム・回答時間付きで表示
