...
オオギリ検定は、AIがあなたのお笑いセンスを診断するエンタメアプリです。お題に回答すると、Gemini AIが**お笑い偏差値・全国上位パーセント・お笑いタイプ・4軸（創造力／毒舌力／シュール力／共感力）**を診断。AI審査員（ラナ／モモ／ミュー）がコメントし、結果は**SNSシェア画像**としてワンタップで投稿できます。
